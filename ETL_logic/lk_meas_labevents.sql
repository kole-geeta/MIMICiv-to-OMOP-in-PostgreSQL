...
--      see etl_dataset.an_labevents_full
...
-- -------------------------------------------------------------------
DROP TABLE IF EXISTS etl_dataset.lk_meas_d_labitems_clean;
CREATE TABLE etl_dataset.lk_meas_d_labitems_clean AS
SELECT
...
FROM
    etl_dataset.src_d_labitems dlab
;
...
-- -------------------------------------------------------------------
DROP TABLE IF EXISTS etl_dataset.lk_meas_labevents_clean;
CREATE TABLE etl_dataset.lk_meas_labevents_clean AS
SELECT
...
-- -------------------------------------------------------------------
DROP TABLE IF EXISTS etl_dataset.lk_meas_d_labitems_concept;
CREATE TABLE etl_dataset.lk_meas_d_labitems_concept AS
SELECT
...
FROM
    etl_dataset.lk_meas_d_labitems_clean dlab
LEFT JOIN
...
-- -------------------------------------------------------------------
DROP TABLE IF EXISTS etl_dataset.lk_meas_labevents_hadm_id;
CREATE TABLE etl_dataset.lk_meas_labevents_hadm_id AS
SELECT
...
FROM  
    etl_dataset.lk_meas_labevents_clean src
INNER JOIN 
...
-- -------------------------------------------------------------------
DROP TABLE IF EXISTS etl_dataset.lk_meas_labevents_mapped;
CREATE TABLE etl_dataset.lk_meas_labevents_mapped AS
SELECT
...
LEFT JOIN 
    etl_dataset.lk_meas_labevents_hadm_id hadm
