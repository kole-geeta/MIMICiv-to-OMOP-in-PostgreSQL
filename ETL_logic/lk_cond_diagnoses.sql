...
-- -------------------------------------------------------------------
DROP TABLE IF EXISTS etl_dataset.lk_diagnoses_icd_clean;
CREATE TABLE etl_dataset.lk_diagnoses_icd_clean AS
SELECT
...
FROM
    etl_dataset.src_diagnoses_icd src
INNER JOIN
...
-- -------------------------------------------------------------------
DROP TABLE IF EXISTS etl_dataset.lk_diagnoses_icd_mapped;
CREATE TABLE etl_dataset.lk_diagnoses_icd_mapped AS
SELECT
    src.subject_id                      AS subject_id,
    src.hadm_id                         AS hadm_id,
    ...
    src.trace_id            AS trace_id  
FROM
    etl_dataset.lk_diagnoses_icd_clean src
LEFT JOIN
...
DROP TABLE IF EXISTS etl_dataset.tmp_seq_num_to_concept;
