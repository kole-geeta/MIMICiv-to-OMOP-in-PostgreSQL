...
DROP TABLE IF EXISTS etl_dataset.cdm_dose_era;
...
-- -------------------------------------------------------------------
DROP TABLE IF EXISTS etl_dataset.tmp_drugIngredientExp;
CREATE TABLE etl_dataset.tmp_drugIngredientExp AS
SELECT
...
FROM etl_dataset.cdm_drug_exposure de
...
-- TODO
-- -------------------------------------------------------------------
DROP TABLE IF EXISTS etl_dataset.tmp_drugWithDose;
CREATE TABLE etl_dataset.tmp_drugWithDose AS
SELECT
...
FROM etl_dataset.tmp_drugIngredientExp
;
...
-- TODO
-- -------------------------------------------------------------------
DROP TABLE IF EXISTS etl_dataset.tmp_cteDoseTarget;
CREATE TABLE etl_dataset.tmp_cteDoseTarget AS
SELECT
...
FROM etl_dataset.tmp_drugWithDose dwd
WHERE
    dose_value <> -1
;
...
-- -------------------------------------------------------------------
DROP TABLE IF EXISTS etl_dataset.tmp_cteDoseEndDates_rawdata;
CREATE TABLE etl_dataset.tmp_cteDoseEndDates_rawdata AS
SELECT
    person_id                                       AS person_id,
...
FROM etl_dataset.tmp_cteDoseTarget
UNION ALL
...
-- TODO
-- -------------------------------------------------------------------
DROP TABLE IF EXISTS etl_dataset.tmp_cteDoseEndDates_e;
CREATE TABLE etl_dataset.tmp_cteDoseEndDates_e AS
SELECT
    person_id                                                                   AS person_id,
    drug_concept_id                                                             AS drug_concept_id,
    unit_concept_id                                                             AS unit_concept_id,
...
FROM etl_dataset.tmp_cteDoseEndDates_rawdata
;
...
-- TODO
-- -------------------------------------------------------------------
DROP TABLE IF EXISTS etl_dataset.tmp_cteDoseEndDates;
CREATE TABLE etl_dataset.tmp_cteDoseEndDates AS
SELECT
    person_id                                       AS person_id,
    drug_concept_id                                 AS drug_concept_id,
    unit_concept_id                                 AS unit_concept_id,
...
FROM etl_dataset.tmp_cteDoseEndDates_e
WHERE
...
-- TODO
-- -------------------------------------------------------------------
DROP TABLE IF EXISTS etl_dataset.tmp_cteDoseFinalEnds;
CREATE TABLE etl_dataset.tmp_cteDoseFinalEnds AS
SELECT
...
FROM etl_dataset.tmp_cteDoseTarget dt
INNER JOIN etl_dataset.tmp_cteDoseEndDates e
...
INSERT INTO etl_dataset.cdm_dose_era
SELECT
...
FROM etl_dataset.tmp_cteDoseFinalEnds
GROUP BY
    person_id,
    drug_concept_id,
    unit_concept_id,
